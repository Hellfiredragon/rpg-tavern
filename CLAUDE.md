...
backend/              Python backend (FastAPI)
  ...
  routes.py           API endpoints under /api (/templates, /adventures, /name-suggestion)
  storage.py          File-based JSON storage (split templates + adventures, preset merging)
  demo.py             Demo data generator (--demo flag)
  static/             Built frontend assets (gitignored, generated by `bun run build`)

frontend/             React + TypeScript (Vite)
  src/
    App.tsx            Three-way URL router: / → QuestBoard, /templates/:slug, /adventures/:slug
